...
export default function Sidebar({
  ...
  sortedSessions.forEach(session => {
    const label = pinnedIds.includes(session.id)
      ? 'Pinned'
      ...
      <>
        ...
        >
          ...
          <div className="p-5 shrink-0">
            <div className="flex items-center justify-between mb-5">
              ...
              >
                ...
                <h2 className="text-xl font-black tracking-tighter text-zinc-900 dark:text-white italic">
                  NEXUS
                </h2>
              </button>
            </div>
                  ...
                  <div className="flex items-center justify-between px-3 pt-4 pb-1.5">
                    ...
                    {group.label !== 'Pinned' &&
                      ...
                      sessions.length > 0 && (
                        <button
                          onClick={onClearAll}
                          className="text-[9px] font-black text-red-400 hover:text-red-500 transition-colors"
                        >
                          ...
                          >
                            ...
                            {isRenaming ? (
                              <input
                                ...
                                onBlur={commitRename}
                                onClick={e => e.stopPropagation()}
                                className="flex-1 min-w-0 bg-white dark:bg-zinc-900 border border-indigo-400 rounded-lg px-2 py-0.5 text-xs"
                              />
                            ) : (
                            ...
                            {isMenuOpen && (
                              ...
                              >
                                <button
                                  ...
                                  className="w-full flex items-center gap-3 px-4 py-3 text-xs font-semibold hover:bg-zinc-50 dark:hover:bg-zinc-800"
                                >
                                ...
                                <button
                                  ...
                                  className="w-full flex items-center gap-3 px-4 py-3 text-xs font-semibold hover:bg-zinc-50 dark:hover:bg-zinc-800 disabled:opacity-50"
                                >
                                  {isSharing ? (
                                ...
                                <button
                                  ...
                                  className="w-full flex items-center gap-3 px-4 py-3 text-xs font-semibold text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30"
                                >
          ...
          <div className="p-4 shrink-0 border-t border-zinc-200 dark:border-zinc-800">
            <div className="flex items-center gap-3 p-3 rounded-2xl bg-zinc-50 dark:bg-zinc-900 mb-2">
              <UserAvatar
                name={user.username}
